...
The rewriting operation we made in this example is again not at all dependent of the list structure: we just used the fact that we know how is made the list produced by \hs{map}. This concept can be simply generalized to recursive structure (as theoretically explained by \cite{Johann:2002:GSF:641433.641471}) and we will see practically how to makes this works in the next part.
