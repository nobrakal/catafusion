...
map g (map f xs)
\end{minted}
\noindent The two \minline{map} will be inlined into it's \minline{buildR} form, but since they have to deal with either a paramorphism or a catamorphism, they need to use \minline{destroy} TODO explain more.
