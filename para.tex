...
has2LeavesBind :: Eq b => 
b -> b -> (a -> b) -> Tree a -> Bool
has2LeavesBind u v f t = 
  has2leaves u v (mapt t f)
\end{minted}
...
\subsection{Validity}
As noticed Domínguez et al. \cite{paramorphismFusion} this is not always a good idea. Consider the previous example example with proper suffixes of a list.
