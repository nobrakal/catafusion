...
This data-type allows us to define a function \minline{switchCombi} (defined in figure \ref{fig:parafus}) that transform a \minline{(Combination a b)} into a real combination function for \minline{paragraph}.
