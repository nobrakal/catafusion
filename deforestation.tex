...
The above statement is notoriously false without restrictions when in presence of $\bot$ (Wadler \cite{WADLER1990231}) or \minline{seq} (Voigtländer \cite{JV04}). The common solution is to impose \emph{strictness} on fused functions. This is done in the case of \minline{cata go} by requiring that \minline{go} is itself strict.
