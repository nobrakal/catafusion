...
\noindent \minline{unfoldr} takes a function that from a seed produce maybe an element and another seed, or nothing. As clever reader already guessed, we can provide anamorphisms for any fixed-point structure, using:
\begin{minted}{Haskell}
