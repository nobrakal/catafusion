...
It is well-known that every catamorphism is a paramorphism where the combination function just don't use the unconsumed structure. Indeed, you can define \minline{cata} as:
\begin{minted}{Haskell}
