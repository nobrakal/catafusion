...
\end{align*}
That is, a function forcing the evaluation of its first argument and returning the second. This characterization is sufficient to break our rule (as it breaks also the \verb|foldr/build| one). Consider the following example:
