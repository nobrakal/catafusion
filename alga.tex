...
We will again adapt the work of of Gill et al. \cite{Gill:1993:SCD:165180.165214}, this time for paramorphisms. We introduce \minline{buildR} (in figure \ref{fig:parafus}) that, similarly to \minline{build}, encode a graph-producing function but this time \emph{using a restricted paramorphism}.
