...
The implementation is pretty straightforward using GHC's rewrite rules described in the work of Peyton Jones \cite{pbr}. A rewrite rule consist in a name and what to rewrite. This last part is an equality where when the left part is encountered in the code TODO.
